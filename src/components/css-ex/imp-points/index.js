...
const ImpPoints = () => {
    return (
        <div class="imp-points-sec">
            <h3 class="header">Important CSS points</h3>
            <h6 class="sub-header"> Width </h6>
            ...
            <h6 class="sub-header"> Positions </h6>
            <ul class="important-points">
            ...
            <h6 class="sub-header"> Center align techniques </h6>
            <ul class="important-points">
                <li>To center align you can set margin to auto. Ex: <blockquote> margin: auto </blockquote></li>
            ...
            <h6 class="sub-header"> Miscelanious </h6>
            <ul class="important-points">
